        ...
        <div className="relative">
            ...
            <button
                ...
                className={cn(
                    ...
                    showGlass || !isHome
                        ? "bg-white/20 border-white/30 text-black hover:bg-white/30 dark:bg-white/20 dark:hover:bg-white/30"
                        : "bg-white/25 border-white/30 text-black hover:bg-white/35"
                )}
                aria-expanded={open}
            >
                {current.flag}
