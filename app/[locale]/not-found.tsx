    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-linear-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                {/* Heading */}
                <motion.h1
                    className="text-3xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-4"
                >
                ...
                {/* Description */}
                <motion.p
                    className="text-lg sm:text-xl text-slate-600 dark:text-slate-400 mb-8 max-w-lg mx-auto"
                >
                ...
                >
                    ...
                    <Link href={`/${locale}`}>
                        <motion.button
                            className="px-8 py-4 bg-linear-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2 group"
                    ...
                    <Link href={`/${locale}/properties`}>
                        <motion.button
                            className="px-8 py-4 bg-slate-200 dark:bg-slate-800 text-slate-900 dark:text-white font-semibold rounded-lg hover:bg-slate-300 dark:hover:bg-slate-700 transition-all duration-300"
                ...
                >
                    <motion.div animate={floatingVariants}>
                        🏠
                    </motion.div>
                    <motion.div animate={floatingVariants} style={{ animationDelay: "0.5s" }}>
                        🔑
                    </motion.div>
                    <motion.div animate={floatingVariants} style={{ animationDelay: "1s" }}>
                        🌅
                    </motion.div>
                </motion.div>
            </motion.div>
