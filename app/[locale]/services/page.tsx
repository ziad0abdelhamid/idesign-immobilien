                ...
                <div className="max-w-7xl mx-auto w-full px-6 grid gap-16">
                    {services.map((service, i) => (
                        <motion.div
                            ...
                            className={`flex flex-col md:flex-row items-center bg-white rounded-2xl overflow-hidden shadow-lg transition-transform hover:scale-[1.02] ${i % 2 === 1 ? "md:flex-row-reverse" : ""
                                }`}
                        >
